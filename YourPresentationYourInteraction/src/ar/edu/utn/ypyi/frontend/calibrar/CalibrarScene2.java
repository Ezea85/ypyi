 ...
 * 
 */
public class CalibrarScene2 extends AbstractScene{
	...
	public CalibrarScene2(MTApplication mtApplication, String name) {
...
//		textField.setFillColor(black);
		...
		textField.setText("    Oprima la tecla (A) del wiimote para calibrar\n" +
						  "Una vez calibrado pruebe el infrarrojo sobre la pantalla");
