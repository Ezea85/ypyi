...
//		centerCircleInner.setStrokeColor(new MTColor(0,0,0));
		...
		//Create the paddles
		PImage paddleTex = mtApplication.loadImage(StartYPYIShell.getPathToIconsYPYI() + "paddle.png");
...
//		ball.setFillColor(ballCol);
		PImage ballTex = mtApplication.loadImage(StartYPYIShell.getPathToIconsYPYI() + "puk.png");
